...
### 홈 화면
<p align="center"><img src="/src/assets/readme_homepage.png" width=225 height= 448/></p>

### 닉네임 설정 화면
<p align="center"><img src="src/assets/readme_nickname_setting.png"  width=225 height= 448/></p>

<div>
  - 닉네임을 설정하고 준비버튼을 누르면 매칭시작 버튼이 활성화됩니다.<br>
   준비완료 버튼을 누르면 준비완료를 해제할 수 있으며, 매칭시작 버튼이 비활성화됩니다.
</div>

### 매칭 화면
<p align="center"><img src="src/assets/readme_matching.png"  width=225 height= 448/></p>

<div>
  - 매칭 시작 버튼을 누르면 매칭시작 버튼을 누른 상대방이 나타날때까지 대기합니다.<br>
   상대방이 나타나면 게임이 바로 시작됩니다.
</div>

### 인게임 화면
<p align="center"><img src="src/assets/readme_ingame.png"  width=225 height= 448/></p>

<div>
  - 좌측 조이스틱을 조작하여 공을 소유할 때에는 슛을, 공을 소유하지 않았을 때에는 달리기를 할 수 있습니다.<br>
   달리기를 하는 경우 2초 동안 달리기를 하며, 2초가 지나면 0.5초 동안 느려집니다(달리기와 지침 상태 구현).
</div>
<div>
  <br>
  - 우측 조이스틱을 조작하면 360도 전 방향으로 부드럽게 이동할 수 있습니다.
</div>
...
- 화면비 9:19.5의 동일한 모바일 기기 간 호환 (ex. iPhone XR이라면 상대방의 기기 또한 iPhone XR이어야 함.)
- 크롬, 사파리 브라우저 호환
...
축구는 제가 가장 좋아하는 취미입니다. 축구와 관련된 좋은 추억이 있는 만큼, 이번 기회에 축구와 관련된 프로젝트를 하고 싶었습니다.
